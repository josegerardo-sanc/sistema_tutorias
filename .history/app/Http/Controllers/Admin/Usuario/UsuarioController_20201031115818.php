    ...
    public function index(Request $request){
      ...
      if($request->ajax()){
        ...
        if($tipo_usuario=="alumno"){
            ...
            $SEMESTRE=isset($data['filtro_semestre_escolar'])?:"";
            $CARRERA=isset($data['filtro_carrera_escolar'])?:"";
            $PERIODO=isset($data['filtro_periodo_escolar'])?:"";
            $TURNO=isset($data['filtro_turno_escolar'])?:"";
            $GRUPO=isset($data['filtro_grupo_escolar'])?:"";
            $MATRICULA=isset($data['filtro_matricula_escolar'])?:"";
            ...
            if($SEMESTRE!=""){
                $WHERE="AND datos_alumnos.carrera=".$SEMESTRE;
            }
            if($SEMESTRE!=""){
                $WHERE="AND datos_alumnos.periodo=".$SEMESTRE;
            }
            if($SEMESTRE!=""){
                $WHERE="AND datos_alumnos.turno=".$SEMESTRE;
            }
            if($SEMESTRE!=""){
                $WHERE="AND datos_alumnos.grupo=".$SEMESTRE;
            }
            if($SEMESTRE!=""){
                $WHERE="AND datos_alumnos.matricula=".$SEMESTRE;
            }
