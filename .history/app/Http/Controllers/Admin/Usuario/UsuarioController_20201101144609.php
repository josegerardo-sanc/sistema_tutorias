              ...
              if(isset($data['img_perfil'])){
                  if($data['img_perfil']!="undefined"||$data['img_perfil']!=null){
                      if($request->hasFile('img_perfil')) {
                        ...
                        if($user_image->path!='Imagenes_usuarios/usuario_default_image.jpg' ){
                            Storage::delete('public/'.$user_image->path);
                         }
                        $data['img_perfil'] =$request->file('img_perfil')->store('Imagenes_usuarios','public');
                        $GaleriaImages=new GaleriaImages;
                        $GaleriaImages->path= $data['img_perfil'];
                        $GaleriaImages->id_user=$id_user_loguin;
                        $GaleriaImages->save();
                        $id_imagen_created=$GaleriaImages->id;
