    ...
    public function index(Request $request){
      ...
      if($request->ajax()){
        ...
        if($tipo_usuario=="alumno"){
            ...
            if($SEMESTRE!=""){
                $WHERE.=" ANDS datos_alumnos.semestre=".$SEMESTRE;
            }
            if($CARRERA!=""){
                $WHERE.="  ANDS datos_alumnos.carrera='$CARRERA'";
            }
            if($PERIODO!=""){
                $WHERE.="  ANDS datos_alumnos.periodo='$PERIODO'";
            }
            // if($TURNO!=""){
            //     $WHERE.="  ANDS datos_alumnos.turno=".$TURNO;
            // }
            if($GRUPO!=""){
                $WHERE.="  ANDS datos_alumnos.grupo='$GRUPO'";
            }
            if($MATRICULA!=""){
