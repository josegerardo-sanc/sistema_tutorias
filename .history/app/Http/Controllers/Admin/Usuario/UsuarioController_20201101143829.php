         ...
         $validatedData = Validator::make($data, [
          ...
          try {
              ...
              if($tipo_usuario=="alumno"){
                $affected=DB::table('datos_alumnos')
                  ...
                  ->update([
                      ...
                      if($affected==0){
                        throw new Exception ("NO SE PUDO REALIZAR LA ACTUALIZACION  DE DATOS_ALUMNO, EXEPTION");
                    }
              ...
              if($tipo_usuario!="alumno" && $tipo_usuario!="administrador"){
                  ...
                  /*
                  if($affected==0){
                    throw new Exception ("NO SE PUDO REALIZAR LA ACTUALIZACION  DE DATOS_DOCENTE, EXEPTION");
                  }*/
              }
