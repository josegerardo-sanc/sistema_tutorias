...
class UsuarioController extends Controller
{
    ...
    public function store(Request $request){
      ...
      try {
        ...
        $validacion_curp=['required','string','max:20','unique:users'];
        //si existe el campo action_update entro el metodo actualizar...
        if($data['action_user_update']!=null && $data['action_user_update']=="update_user"){
            $validacion_curp= ['required','email','max:50','sometimes','unique:users,email,'.$Model_user->id];
        }
       ...
       $validatedData = Validator::make($data, [
        ...
        //si existe el campo action_update entro el metodo actualizar...
        if($data['action_user_update']!=null && $data['action_user_update']=="update_user"){
            return json_encode($this->update($request));
        }
    ...
    public function update(Request $request){
        ...
        return ['status'=>200,'info'=>'actualizar','resquest_data'=>$request->all()];
    }
