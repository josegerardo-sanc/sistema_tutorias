        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="col-sm-4 form-group">
                    <label for="" class="col-form-label label">Tipo de usuario</label>
                        <select class="form-control personaliza_selected" name="tipo_usuario_search" id="tipo_usuario_search">
