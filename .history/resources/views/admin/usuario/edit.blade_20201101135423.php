                    ...
                    <form action="#" id="formData_DatosPersonales">
                        ...
                        <div class="card-body pb-2">
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{$usersData[0]->id_user}}"  name="id_user" id="id_user"
                            ...
                            <div class="row form-group contenedor_referencia_btn_this">
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input value="{{$usersData[0]->curp}}" 
                                    name="curp" id="curp" type="text" class="form-control input_curp_validar "  mamaxlength="18">
                                    <div class="content_error_curp">info de validacion de la curp</div>
                                </div>
                                <div class="col-sm-2 form-group">
                                    <label class="form-label">RFC</label>
                                    <input value="{{$usersData[0]->rfc}}" 
                                    name="rfc" id="rfc" type="text" class="form-control" maxlength="4">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input value="{{$usersData[0]->nombre}}" 
                                name="nombre" id="nombre" type="text" class="form-control mb-1" maxlength="20">
                            </div>

                            <div class="row form-group">
                                <div class="col-sm-6 form-group">
                                    <label class="form-label">Apellido Paterno</label>
                                    <input value="{{$usersData[0]->ap_paterno}}" 
                                    name="ap_paterno" id="ap_paterno" type="text" class="form-control" maxlength="15">
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label class="form-label">Apellido Materno</label>
                                    <input value="{{$usersData[0]->ap_materno}}" 
                                    name="ap_materno" id="ap_materno" type="text" class="form-control mb-1"  maxlength="15">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                <div class="col-sm-4 form-group">
                                    ...
                                    <input value="{{$usersData[0]->fecha_nacimiento}}" 
                                    name="fecha_nacimiento" id="fecha_nacimiento" type="date" class="form-control">
                                </div>
                                <div class="col-sm-4 form-group contenedor_principal_validar">
                                    <label class="form-label">Telefono</label>
                                    <input value="{{$usersData[0]->telefono}}" 
                                    name="telefono" id="telefono" type="text" class="form-control validate_telefono_lada validar_numeric_input"  maxlength="10">
                                    <div class="content_error_validar_lada"></div>
                                </div>
                                <div class="col-sm-4 form-group conte_email_validar">
                                    <label class="form-label">Correo</label>
                                    <input value="{{$usersData[0]->email}}" 
                                    name="email" id="email" type="email" class="form-control valid_email_express_regular"  maxlength="50">
                        ...
                        <div class="card-body ContenedorcodigoPostal_father">
                            ...
                            <div class="form-group">
                                ...
                                <div class="display:flex">
                                    <input value="{{$usersData[0]->code_postal}}"
                                    name="codigo_postal" id="codigo_postal" type="text" class="form-control mb-1 inputBuscarCodigoPostal"  maxlength="5">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-4 form-group">
                                    ...
                                    <select class="form-control localidad_complete" name="localidad" id="localidad_edit">
...
<script>
   ...
   if(tipo_user_selected=="alumno"){
        ...
        let matricula="<?php echo isset($usersData[0]->matricula)?$usersData[0]->matricula:''; ?>";
        let matricula="<?php echo isset($usersData[0]->periodo)?$usersData[0]->matricula:''; ?>";
        let matricula="<?php echo isset($usersData[0]->semestre)?$usersData[0]->matricula:''; ?>";
        let matricula="<?php echo isset($usersData[0]->carrera)?$usersData[0]->matricula:''; ?>";
        let matricula="<?php echo isset($usersData[0]->grupo)?$usersData[0]->matricula:''; ?>";
        let matricula="<?php echo isset($usersData[0]->turno)?$usersData[0]->matricula:''; ?>";


        $('.btn_tab_conte_dtsAcademicos').css({'display':''}).html('DATOS ACADEMICOS ALUMNO').show();
        $('#conte_alumno_academico').show();
   }else if(tipo_user_selected!="alumno"&&tipo_user_selected!="administrador"){
      

    let cedula_profesioanl="<?php echo isset($usersData[0]->cedula_profesional)?$usersData[0]->cedula_profesional:''; ?>"
    $('#cedula_profesioanl').val(cedula_profesioanl);

    
      $('.btn_tab_conte_dtsAcademicos').css({'display':''}).html('DATOS ACADEMICOS DOCENTE').show();
