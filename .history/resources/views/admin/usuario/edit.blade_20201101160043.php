...
<div class="layout-content">
                        ...
                        <div class="card-body pb-2">
                            ...
                            <div class="row form-group mb-3">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <select name="" id="" class="col-sm-12 form-control">
                                        <option value="1" {{$usersData[0]->active=="1"?'selected':''}} >Activar cuenta</option>
                                        <option value="2" {{$usersData[0]->active=="2"?'selected':''}}>Deshabilitar cuenta</option>
                                        <option value="3" {{$usersData[0]->active=="3"?'selected':''}} disabled>En verificación</option>
                                    </select>
                                    ...
                                    <small>La cuenta se encuentra <span class="badge {$cuenta_status}">{{$cuenta_text}}</span></small>
                                </div>
                            </div>
    ...
    if (tipo_user_selected == "alumno") {
        ...
        $('.btn_tab_conte_dtsAcademicos').css({
            'display': ''
        }).html('DATOS ACADEMICOS ALUMNO').show();
        ...
        $('.btn_tab_conte_dtsAcademicos').css({
            'display': ''
        }).html('DATOS ACADEMICOS DOCENTE').show();
