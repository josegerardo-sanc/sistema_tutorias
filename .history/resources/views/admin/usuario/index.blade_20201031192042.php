                            ...
                            <div class="row align-items-center m-l-0">
                                ...
                                <div class="col-sm-12 row">
                                    ...
                                    <div class="col-sm-12 mt-4">
                                        <button type="button" class="btn mr-2 BTN_LIMPIAR_FILTRO" style="background-color:#FE9838;color:white; margin:0px 4px;">Cancelar</button>
                                        <button type="button" class="btn mr-2 BTN_SEND_SEARCH" style="background-color:#1050B9;color:white">Consultar</button>
                                        <button type="button" class="btn mr-2 BTN_SEND_SEARCH" style="background-color:#E61414;color:white">Ocultar</button>
