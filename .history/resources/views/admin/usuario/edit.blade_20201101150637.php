                        ...
                        <div class="card-body pb-2">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="row col-sm-4 ">
                                    <label for="" class="col-sm-12 form-label">Cuenta</label>
                                    <div class="col-sm-3 form-group">
                                        <label class="custom-control custom-checkbox m-0">
                                            <input name="cuenta_user" id="cuenta_user_activar" value="1" type="radio"
                                    ...
                                    <div class="col-sm-3 form-group">
                                        <label class="custom-control custom-checkbox m-0">
                                            <input name="cuenta_user" id="cuenta_user_desactivar" value="0" type="radio"
                                                class="custom-control-input">
                                            <span class="custom-control-label">Desactivar</span>
                                        </label>
                                    </div>
                                </div>
                            </div>
