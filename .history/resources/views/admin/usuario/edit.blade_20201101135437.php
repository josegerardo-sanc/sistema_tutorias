...
<script>
   ...
   if(tipo_user_selected=="alumno"){
        ...
        let matricula="<?php echo isset($usersData[0]->periodo)?$usersData[0]->periodo:''; ?>";
        let matricula="<?php echo isset($usersData[0]->semestre)?$usersData[0]->semestre:''; ?>";
        let matricula="<?php echo isset($usersData[0]->carrera)?$usersData[0]->carrera:''; ?>";
        let matricula="<?php echo isset($usersData[0]->grupo)?$usersData[0]->grupo:''; ?>";
        let matricula="<?php echo isset($usersData[0]->turno)?$usersData[0]->turno:''; ?>";
