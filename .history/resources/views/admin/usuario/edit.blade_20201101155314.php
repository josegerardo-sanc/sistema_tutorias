                    ...
                    <form action="#" id="formData_DatosPersonales">
                        ...
                        <div class="card-body pb-2">
                            ...
                            <div class="row form-group mb-3">
                                ...
                                <div class="col-sm-5">
                                    <label for="" class="col-sm-12 col-for-label"  style="padding:10px;"> <strong>Cuenta</strong></label>
                                    <select name="" id="" class="col-sm-12 form-control">
                                        <option value="1" >Activar cuenta</option>
                                        <option value="2" >Deshabilitar cuenta</option>
                                        <option value="3" disabled>verificación</option>
                                    </select>
                                </div>
                            </div>
