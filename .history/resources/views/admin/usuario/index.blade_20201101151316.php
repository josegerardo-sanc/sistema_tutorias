                        ...
                        <div class="row align-items-center m-l-0">
                            ...
                            <div class="col-sm-12 row">
                                <div class="col-sm-12 form-group">
                                    ...
                                    <select class="form-control selected_tipo_user" name="tipo_usuario_search"
                                        id="tipo_usuario_search">
                                ...
                                <div class="col-sm-12 mt-4 d-flex justify-content-end">
                                    <div>
                                        <button type="button" class="btn mr-2 BTN_SEND_SEARCH"
                                            style="background-color:#1050B9;color:white">Consultar</button>
                                        <button type="button" class="btn mr-2 BTN_LIMPIAR_FILTRO"
                                            style="background-color:#FE9838;color:white; margin:0px 4px;">Limpiar</button>
                                        <button type="button" class="btn mr-2 BTN_OCULTAR_FILTRO"
                                            style="background-color:#E61414;color:white">Ocultar</button>
            ...
            <div class="col-sm-12 row contenedor_card_users" style="width:!00%;">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card user-card user-card-1 mt-4">
                        <div class="card-body conte_user" data-id_user="{{$usuario->id}}"
                            data-status_cuenta="{{ $cuenta_text}}" data-user_name="{{ $usuario->nombre }}">
                            <div class="user-about-block text-center">
                                <div class="row align-items-start">
                                    ...
                                    <div class="col"><img class="img-radius img-fluid wid-80"
                                            src="{{asset('storage').'/'.$usuario->photo}}" alt="Foto de perfil"></div>
                                    <div class="col text-right pb-3">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item btn_editar_user_index"
                                                    href="{{url('/Admin/user/'.$usuario->id.'/edit')}}">Edit</a>
                            ...
                            <div class="text-center">
                                ...
                                <?php
                                    ...
                                    ?>
                                <p class="mb-3 text-muted"><i class="fas fa-user-tag"></i>
                                    </i>{{$usuario->tipo_usuario}} </p>
                                <p class="mb-1"><b>Email : </b><a
                                        href="mailto:dummy@example.com">{{$usuario->email }}</a></p>
...
function tipoUserHTML(usuario) {
    ...
    if (usuario.tipo_usuario != "alumno" && usuario.tipo_usuario != "administrador") {
        complemento_html = `
            <p class="mb-0"><b> Cedula ${usuario.cedula_profesional}  <span class="badge badge-warning"></span></p>
            `;
                                        ...
                                        <div class="row align-items-start">
                                            ...
                                            <div class="col text-right pb-3">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        <a class="dropdown-item btn_editar_user_index" href="#">Editar</a>
                                                        <a class="dropdown-item" href="#" style="display:none;">History</a>
                                                        <a class="dropdown-item" href="#" style="display:none;">Trash</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
