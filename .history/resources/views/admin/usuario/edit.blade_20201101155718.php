                            ...
                            <div class="row form-group mb-3">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <select name="" id="" class="col-sm-12 form-control">
                                        ...
                                        <option value="2" {{$usersData[0]->active=="2"?'selected disabled':''}}>Deshabilitar cuenta</option>
                                        <option value="3" {{$usersData[0]->active=="3"?'selected disabled':''}} disabled>En verificación</option>
                                    </select>
                                </div>
                            </div>
