                    ...
                    <form action="#" id="formData_DatosPersonales">
                        ...
                        <div class="card-body pb-2">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-4">
                                    <label for="" class="col-form-label" style="display:block">Cuenta</label>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline1" name="customRadioInline1" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadioInline1">Activar</label>
                                    </div>
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input">
                                        <label class="custom-control-label" for="customRadioInline2">Desactivar</label>
                                    </div>
                                </div>
                            </div>
