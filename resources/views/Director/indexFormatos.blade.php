...
<script>
    ...
    function getFormatos_all(){
        array_archivosDb=[];
        $.ajax(
        {
          url :'/director/formatosListar',
          type:'POST',
                            ...
                            reportes_html+=`<div class="file-item contenedor_file_item_"
                                            ...
                                            <div class="file-item-actions btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item btn_archivo_descargar" href="/director/downloadFormato/${iterator.id_archivo}">Descargar</a>
                                                </div>
                                            </div>
                                    </div>`;
