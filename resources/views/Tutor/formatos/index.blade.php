...
<div class="layout-content">
    ...
    <div class="container-fluid flex-grow-1 container-p-y">
        <h4 class="display-4" style="color: #DF480F">Lista de Formatos</h4>
...
<script>
    ...
    function getFormatosTutores(){
        array_archivosDb=[];
        $.ajax(
        {
          url :'/formatosTutores/formatos',
          type:'POST',
                            ...
                            reportes_html+=`<div class="file-item contenedor_file_item_"
                                            ...
                                            <div class="file-item-actions btn-group">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item btn_archivo_descargar" href="/formatosTutores/downloadFormato/${iterator.id_archivo}">Descargar</a>
                                                </div>
                                            </div>
                                    </div>`;
