        ...
        <div class="navbar-nav align-items-lg-center ml-auto">
            ...
            <div class="demo-navbar-messages nav-item dropdown mr-lg-3">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <div class="list-group list-group-flush">
                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                            <img src="{{ asset('dashboard_assets/img/avatars/6-small.png')}}" class="d-block ui-w-40 rounded-circle" alt>
                        ...
                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                            <img src="{{ asset('dashboard_assets/img/avatars/4-small.png')}}" class="d-block ui-w-40 rounded-circle" alt>
                            <div class="media-body ml-3">
                        ...
                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                            <img src="{{ asset('dashboard_assets/img/avatars/5-small.png" class="d-block ui-w-40 rounded-circle" alt>
                            <div class="media-body ml-3">
                        ...
                        <a href="javascript:" class="list-group-item list-group-item-action media d-flex align-items-center">
                            <img src="dashboard_assets/img/avatars/11-small.png')}}" class="d-block ui-w-40 rounded-circle" alt>
                            <div class="media-body ml-3">
